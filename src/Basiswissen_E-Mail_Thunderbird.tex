...
\frame{
	\frametitle{Ordner anlegen II}
	   ...
	   \end{figure}
	   \textit{Rechtsklick} $\rightarrow$ New Folder oder New Subfolder
   }
...
\subsecframe{Manage Identities / Aliases}{
	Accounts $\rightarrow$ View settings for this account $\rightarrow$ Manage Identities $\rightarrow$ Add
	Konten $\rightarrow$ Zeige Kontoeinstellungen $\rightarrow$ 
   \begin{figure}
